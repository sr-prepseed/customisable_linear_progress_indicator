import 'package:customizable_linear_progress_indicator/customizable_linear_progress_indicator.dart';
import 'package:example/widgets/common_image_view.dart';
      ...
      body: Center(
        ...
        child: LinearProgressWidget(
          ...
          onProgressChanged: (value) {
            print("Progress: ${value.toStringAsFixed(2)}");
          },
        ),
      ),
